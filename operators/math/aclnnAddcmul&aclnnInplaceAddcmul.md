...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul>
          <li>self与tensor1、tensor2的数据类型满足数据类型推导规则（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>），且推导后的类型需要在支持的输入类型里。</li>
          <li>self与tensor1、tensor2的shape满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</li>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>tensor1与self、tensor2的数据类型满足数据类型推导规则（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>），且推导后的类型需要在支持的输入类型里。</li>
          <li>tensor1与self、tensor2的shape满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</li>
        </ul>
      </td>
      <td>FLOAT、FLOAT16、DOUBLE、BFLOAT16、INT32、INT64、INT8、UINT8</td>
      <td>ND</td>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>tensor2与self、tensor1的数据类型满足数据类型推导规则（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>），且推导后的类型需要在支持的输入类型里。</li>
          <li>tensor2与self、tensor1的shape满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</li>
        </ul>
      </td>
      <td>FLOAT、FLOAT16、DOUBLE、BFLOAT16、INT32、INT64、INT8、UINT8</td>
      <td>ND</td>
    ...
    <tr>
      ...
      <td>输入</td>
      <td>公式中的输入value。</td>
      <td>数据类型需要可转换成self与tensor1、tensor2推导后的数据类型（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
      <td>FLOAT、FLOAT16、DOUBLE、BFLOAT16、INT32、INT64、INT8、UINT8</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>数据类型是self与tensor1、tensor2推导之后可转换的数据类型（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</li>
...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul>
          <li>selfRef与tensor1、tensor2的数据类型满足数据类型推导规则（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>），且推导后的数据类型可以转换为selfRef的数据类型（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>），且推导后的类型需要在支持的输入类型里。</li>
          <li>selfRef与tensor1、tensor2的shape满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>，shape需要与selfRef、tensor1、tensor2 broadcast之后的shape一致。</li>
        </ul>
      </td>
      <td>FLOAT、FLOAT16、DOUBLE、BFLOAT16、INT32、INT64、INT8、UINT8</td>
      <td>ND</td>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>tensor1与selfRef、tensor2的数据类型满足数据类型推导规则（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>），且推导后的类型需要在支持的输入类型里。</li>
          <li>tensor1与selfRef、tensor2的shape满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</li>
        </ul>
      </td>
      <td>FLOAT、FLOAT16、DOUBLE、BFLOAT16、INT32、INT64、INT8、UINT8</td>
      <td>ND</td>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>tensor2与selfRef、tensor1的数据类型满足数据类型推导规则（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>），且推导后的类型需要在支持的输入类型里。</li>
          <li>tensor2与selfRef、tensor1的shape满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</li>
        </ul>
      </td>
      <td>FLOAT、FLOAT16、DOUBLE、BFLOAT16、INT32、INT64、INT8、UINT8</td>
      <td>ND</td>
    ...
    <tr>
      ...
      <td>输入</td>
      <td>公式中的输入value。</td>
      <td>数据类型需要可转换成selfRef与tensor1、tensor2推导后的数据类型（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
      <td>FLOAT、FLOAT16、DOUBLE、BFLOAT16、INT32、INT64、INT8、UINT8</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
