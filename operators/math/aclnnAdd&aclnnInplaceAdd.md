...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul>
          <li>数据类型与other的数据类型需满足数据类型推导规则（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>）。</li>
          <li>shape需要与other满足[broadcast关系](../common/broadcast关系.md)。</li>
        <ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>数据类型需要是self与other推导之后可转换的数据类型（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</li>
...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul>
          <li>shape需要与other满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>，且广播后的shape必须等于selfRef的shape。</li>
          <li>数据类型与other的数据类型需满足数据类型推导规则（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>），且需要是推导之后可转换的数据类型（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</li>
        </ul>
      </td>
      <td>FLOAT、FLOAT16、DOUBLE、INT32、INT64、INT16、INT8、UINT8、BOOL、COMPLEX128、COMPLEX64、BFLOAT16</td>
      <td>ND</td>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>数据类型与selfRef的数据类型需满足数据类型推导规则（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>）。</li>
          <li>shape需要与selfRef满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</li>
        </ul>
      </td>
      <td>FLOAT、FLOAT16、DOUBLE、INT32、INT64、INT16、INT8、UINT8、BOOL、COMPLEX128、COMPLEX64、BFLOAT16</td>
      <td>ND</td>
