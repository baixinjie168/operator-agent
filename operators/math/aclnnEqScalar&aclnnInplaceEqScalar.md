...
- 每个算子分为[两段式接口](../common/两段式接口.md)，必须先调用“aclnnEqScalarGetWorkspaceSize”或者“aclnnInplaceEqScalarGetWorkspaceSize”接口获取计算所需workspace大小以及包含了算子计算流程的执行器，再调用“aclnnEqScalar”或者“aclnnInplaceEqScalar”接口执行计算。
...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>输出</td>
      <td>公式中的out。</td>
      <td>数据类型BOOL可转换的数据类型（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
  ...
  - <term>Atlas A2 训练系列产品/Atlas A2 推理系列产品</term>、<term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>：
    - self与other满足[互推导关系](../common/互推导关系.md)。
...
- **参数说明：**
  ...
  - <term>Atlas A2 训练系列产品/Atlas A2 推理系列产品</term>、<term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>：
    - selfRef与other满足[互推导关系](../common/互推导关系.md)。
