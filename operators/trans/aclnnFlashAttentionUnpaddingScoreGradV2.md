...
- 接口功能：训练场景下计算注意力的反向输出，即[aclnnFlashAttentionVarLenScoreV2](aclnnFlashAttentionVarLenScoreV2.md)的反向计算。**该接口相较于[aclnnFlashAttentionUnpaddingScoreGrad](aclnnFlashAttentionUnpaddingScoreGrad.md)接口，新增psetype参数**：
