...
![MlaPreprocess图](../figures/MlaPreprocess计算过程.png)
...
## 函数原型
每个算子分为[两段式接口](../common/两段式接口.md)，必须先调用“aclnnMlaPreprocessV2GetWorkspaceSize”接口获取入参并根据流程计算所需workspace大小，再调用“aclnnMlaPreprocessV2”接口执行计算。
...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>数据类型需要与input满足数据类型推导规则（参见<a href="../common/互推导关系.md">互推导关系</a>和<a href="#约束说明">约束说明</a>）。</td>
      <td>FLOAT16、BFLOAT16</td>
      <td>ND</td>
      <td>[hiddenSize]</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td>输入格式随cacheMode变化：<ul>
        <li>cacheMode为0：shape为[blockNum,blockSize,1,576]，dtype与input保持一致，<a href="../common/数据格式.md">数据格式</a>为ND。</li>
        <li>cacheMode为1：shape为[blockNum,blockSize,1,512]，tensor的shape为拆分情况，dtype与input保持一致，<a href="../common/数据格式.md">数据格式</a>为ND。</li>
        <li>cacheMode为2：shape为[blockNum,16,blockSize,32]，dtype为int8，<a href="../common/数据格式.md">数据格式</a>为NZ。</li>
        <li>cacheMode为3：shape为[blockNum,32,blockSize,16]，dtype与input保持一致，<a href="../common/数据格式.md">数据格式</a>为NZ。</li></ul>
      </td>
      <td>INT8、FLOAT16、BFLOAT16</td>
      <td>ND、NZ</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td>可选参数，支出传入空指针，输入格式随cacheMode变化：<ul>
        ...
        <li>cacheMode为1：shape为[blockNum,blockSize,1,64]，dtype与input保持一致，<a href="../common/数据格式.md">数据格式</a>为ND。</li>
        <li>cacheMode为2或3：shape为[blockNum,4,blockSize,16]，dtype与input保持一致，<a href="../common/数据格式.md">数据格式</a>为NZ。</li></ul>
      </td>
      <td>FLOAT16、BFLOAT16</td>
      <td>ND、NZ</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td>shape和dtype随cacheMode变化：<ul>
        <li>cacheMode为0：shape为[tokenNum, headNum, 576]，dtype与input一致，<a href="../common/数据格式.md">数据格式</a>为ND。</li>
        <li>cacheMode为1或3：shape为[tokenNum, headNum, 512]，dtype与input一致，<a href="../common/数据格式.md">数据格式</a>为ND。</li>
        <li>cacheMode为2：shape为[tokenNum, headNum, 512]，dtype为INT8，<a href="../common/数据格式.md">数据格式</a>为ND格式。</li>
      </td>
      <td>INT8、FLOAT16、BFLOAT16</td>
      <td>ND</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td>shape和dtype随cacheMode变化：<ul>
        <li>cacheMode为0：shape为[blockNum, blockSize, 1, 576]， dtype与input一致，<a href="../common/数据格式.md">数据格式</a>为ND。</li>
        <li>cacheMode为1：shape为[blockNum, blockSize, 1, 512]， dtype与input一致，<a href="../common/数据格式.md">数据格式</a>为ND。</li>
        <li>cacheMode为2：shape为[blockNum, 16, blockSize, 32]，dtype为INT8，<a href="../common/数据格式.md">数据格式</a>为NZ。</li>
        <li>cacheMode为3：shape为[blockNum, 32, blockSize, 16]，dtype与input一致，<a href="../common/数据格式.md">数据格式</a>为NZ。</li>
      </td>
      <td>INT8、FLOAT16、BFLOAT16</td>
      <td>ND、NZ</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td>shape和dtype随cacheMode变化：<ul>
        ...
        <li>cacheMode为1或3：shape为[tokenNum, headNum, 64]，dtype与input一致，<a href="../common/数据格式.md">数据格式</a>为ND。</li>
        <li>cacheMode为2：shape为[tokenNum, headNum, 64]，dtype与input一致，<a href="../common/数据格式.md">数据格式</a>为ND。</li>
      </td>
      <td>FLOAT16、BFLOAT16</td>
      <td>ND</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td>shape和dtype随cacheMode变化：<ul>
        <li>cacheMode为0：不输出。</li>
        <li>cacheMode为1：shape为[blockNum, blockSize, 1, 64]，dtype与input一致，<a href="../common/数据格式.md">数据格式</a>为ND。</li>
        <li>cacheMode为2：cacheMode为2或3：shape为[blockNum, 4, blockSize, 16]，dtype与input一致，<a href="../common/数据格式.md">数据格式</a>为NZ
      </td>
      <td>FLOAT16、BFLOAT16</td>
      <td>ND、NZ</td>
      <td>-</td>
