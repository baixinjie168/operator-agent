    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>支持1-BSND的4维Tensor、4-TND的3维Tensor。</li>
        </ul>
      </td>
      <td>int64</td>
      <td>-</td>
...
- **返回值：**
  ...
  <tbody>
    <tr>
      ...
      <td>161001</td>
      <td>传入的queryRef、keyRef、cos或sin是空指针。</td>
    </tr>
    <tr>
      <td rowspan="3">ACLNN_ERR_PARAM_INVALID</td>
      <td rowspan="3">161002</td>
      <td>传入的queryRef、keyRef、cos、sin的数据类型、数据格式不在支持的范围内或shape不匹配。</td>
    </tr>
    <tr>
      <td>传入的layout参数不在支持范围内。</td>
    </tr>
    <tr>
      <td>传入的rotaryMode参数不在支持范围内。</td>
    </tr>
  </tbody>
  </table>
