...
- **返回值**
    ...
    <tr>
        ...
        <td>161001</td>
        <td>传入的x、weight、groupEp、groupTp或y1Out是空指针。</td>
    </tr>
    <tr>
        <td rowspan="6">ACLNN_ERR_PARAM_INVALID</td>
        <td rowspan="6">161002</td>
        <td>groupEp或groupTp字符串长度不合法。</td>
    </tr>
    <tr>
        <td>输入不支持的数据类型。</td>
    </tr>
    ...
    <tr>
        <td>aclTensor维度不合法。</td>
    </tr>
    <tr>
        <td>aclTensor shape不合法。</td>
    </tr>
    <tr>
        <td>使能可选输出场景非法——当需要y3OutOptional可选输出时，actType需不为0。</td>
    </tr>
    </tbody>
    </table>
