...
每个算子分为[两段式接口](../common/两段式接口.md)，必须先调用“aclnnNormRopeConcatBackwardGetWorkspaceSize”接口获取入参并根据计算流程计算所需workspace大小，再调用“aclnnNormRopeConcatBackward”接口执行计算。
...
- **参数说明**
    ...
    <table style="undefined;table-layout: fixed; width: 1602px"><colgroup>
