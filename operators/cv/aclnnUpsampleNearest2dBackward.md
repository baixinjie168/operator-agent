...
- 接口功能：[aclnnUpsampleNearest2dV2](aclnnUpsampleNearest2dV2.md)的反向传播。<!--[aclnnUpsampleNearest2d](./aclnnUpsampleNearest2d.md)的反向传播。-->
...
每个算子分为[两段式接口](../common/两段式接口.md)，必须先调用“aclnnUpsampleNearest2dBackwardGetWorkspaceSize”接口获取入参并根据计算流程计算所需workspace大小，再调用“aclnnUpsampleNearest2dBackward”接口执行计算。
