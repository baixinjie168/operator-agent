...
[📄 查看源码](https://gitcode.com/cann/ops-nn/tree/master/matmul/addmv)
...
每个算子分为[两段式接口](../common/两段式接口.md)，必须先调用“aclnnAddmvGetWorkspaceSize”接口获取计算所需workspace大小以及包含了算子计算流程的执行器，再调用“aclnnAddmv”接口执行计算。
...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td><ul><li>数据类型需要与 mat@vec 构成<a href="../common/互推导关系.md">互推导关系。</a></li>
      <li>shape在alpha不为0时需要与 mat@vec 满足<a href="../common/broadcast关系.md">broadcast关系。</a></li>
    ...
    <tr>
      ...
      <td><ul><li>数据类型需要与self构成<a href="../common/互推导关系.md">互推导关系。</a></li>
    ...
    <tr>
      ...
      <td>输出</td>
      <td>指定的1维输出向量。</td>
      <td><ul><li>数据类型需要是self, mat, vec, alpha, beta<a href="../common/互推导关系.md">推导后的数据类型。</a></li>
