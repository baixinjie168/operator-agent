...
- 每个算子分为[两段式接口](../common/两段式接口.md)，必须先调用“aclnnHardswishGetWorkspaceSize”或者“aclnnInplaceHardswishGetWorkspaceSize”接口获取计算所需workspace大小以及包含了算子计算流程的执行器，再调用“aclnnHardswish”或者"aclnnInplaceHardswish"接口执行计算。
...
- **参数说明：**
  ...
  <tbody>
      ...
      <td><ul><li>支持空Tensor。</li><li>self的数据类型需要是可转换为out的数据类型（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</li></ul></td>
    ...
    <tr>
      ...
      <td>out的数据类型需要是可转换为self的数据类型（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
      <td>BFLOAT16、FLOAT16、FLOAT32</td>
      <td>ND</td>
      <td>0-8</td>
      <td>√</td>
