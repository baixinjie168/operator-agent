...
- 每个算子分为[两段式接口](../common/两段式接口.md)，必须先调用“aclnnReluGetWorkspaceSize”或者“aclnnInplaceReluGetWorkspaceSize”接口获取入参并根据计算流程计算所需workspace大小，再调用“aclnnRelu”或者“aclnnInplaceRelu”接口执行计算。
