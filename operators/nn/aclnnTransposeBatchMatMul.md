...
每个算子分为[两段式接口](../common/两段式接口.md)，必须先调用“aclnnTransposeBatchMatMulGetWorkspaceSize”接口获取入参并根据流程计算所需workspace大小，再调用“aclnnTransposeBatchMatMul”接口执行计算。
```cpp
  ...
  <table style="undefined;table-layout: fixed;width: 1567px"><colgroup>
    ...
    <thead>
      <tr>
        ...
        <th>使用说明</th>
        <th>数据类型</th>
        <th><a href="../common/数据格式.md" target="_blank">数据格式</a></th>
        <th style="white-space: nowrap">维度</th>
        <th><a href="../common/非连续的Tensor.md" target="_blank">非连续的Tensor</a></th>
      <tr>
    </thead>
    <tbody>
      <tr>
        ...
        <td>
          <ul>
            <li>数据类型需要与x2满足数据类型推导规则（参见<a href="../common/互推导关系.md">互推导关系</a>和<a href="#约束说明">约束说明</a>）。</li>
      ...
      <tr>
        ...
        <td>
        <ul>
            <li>数据类型需要与x1满足数据类型推导规则（参见<a href="../common/互推导关系.md">互推导关系</a>和<a href="#约束说明">约束说明</a>）。</li>
      ...
      <tr>
        ...
        <td>
        <ul>
          <li> 数据类型需要与x1与x2推导之后的数据类型保持一致（参见<a href="../common/互推导关系.md">互推导关系</a>和<a href="#约束说明">约束说明</a>）。</li>
