...
每个算子分为[两段式接口](../common/两段式接口.md)，必须先调用“aclnnConvTbcBackwardGetWorkspaceSize”接口获取计算所需workspace大小以及包含了算子计算流程的执行器，再调用“aclnnConvTbcBackward”接口执行计算。
...
- 确定性计算
  ...
  <table style="undefined;table-layout: fixed; width: 1200px"><colgroup>
   ...
   <tr>
     ...
     <td>各个维度的大小应在[1,2147483646]的范围内。</td>
     <td>-</td>
   </tr>
   <tr>
   ...
   <tr>
     ...
     <td>L的大小应该在[1,255]的范围内，其他维度的大小应该在[1,2147483646]的范围内。</td>
     <td>-</td>
   </tr>
   <tr>
