...
- **参数说明：**
  ...
  <thead>
   ...
   <tbody>
      ...
      <td><ul><li>支持空Tensor。</li><li>需要与values满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</li></ul></td>
    ...
    <tr>
      ...
      <td><ul><li>支持空Tensor。</li><li>需要与input满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</li></ul></td>
      <td>BFLOAT16、FLOAT16、FLOAT</td>
      <td>ND</td>
      <td>0-8</td>
      <td>√</td>
