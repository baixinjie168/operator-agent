...
[📄 查看源码](https://gitcode.com/cann/ops-nn/tree/master/index/embedding_dense_grad_v2)
...
实现[aclnnEmbedding](./aclnnEmbedding.md)的反向计算, 将相同索引`indices`对应`grad`的一行累加到`out`上。
